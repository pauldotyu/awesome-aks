...
- Resource group
- AKS Automatic cluster with Gateway API and Istio app routing enabled
- Node Autoprovision AKSNodeClass for Managed GPU experience (NVIDIA drivers managed by AKS)
